...
//       // Optional: generate new token after password change
//       // Assuming backend returns new JWT
...
//       // localStorage.removeItem(role === "admin" ? "adminToken" : "studentToken");
...
//         <div className="w-full max-w-md bg-white p-6 rounded-xl shadow-lg mt-10">
