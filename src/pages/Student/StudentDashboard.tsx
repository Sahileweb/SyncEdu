...
export default function StudentDashboard() {
  ...
  const renderAnswerSection = () => {
    ...
    // If Task is COMPLETED -> Show "Completed" Status (NO Upload Box)
    ...
    //  If Task is PENDING + ANSWER UPLOADED -> Show "Finalize" Button
    ...
    // If Task is PENDING + NO ANSWER -> Show Upload Box
    return (
      <div className="space-y-4">
